            ...
            <?php if (!empty($arResult['QUESTIONS']) || $arResult['isUseCaptcha']) { ?>
                <div class="form-result-new-fields intec-ui-form-fields">
                    <?php foreach ($arResult['QUESTIONS'] as $arQuestion) { ?>
                        <label class="form-result-new-field intec-ui-form-field <?if($arQuestion['REQUIRED'] == 'Y'){?>intec-ui-form-field-required<?}?>">
            ...
            <div class="form-result-new-buttons">
                <div class="intec-grid intec-grid-wrap intec-grid-i-5">
                    <div class="intec-grid-item-auto">
                        ...
                        <?= Html::submitButton(!empty($arResult['arForm']['BUTTON']) ? "Отправить" : "Отправить", [
                            'class' => [
                                'intec-ui' => [
                                    '',
                                    'control-button',
