...
<div class="ns-bitrix c-form-result-new c-form-result-new-template-1 intec-form" id="<?= $sTemplateId ?>">
    ...
    <?php } else { ?>
        ...
        <?php if ($arResult["isFormErrors"] == 'Y' && (isset($_REQUEST["AJAX_CALL"]) || isset($_REQUEST["sessid"]))) { ?>
        ...
        <div class="form-result-new-form-buttons-wrap">
            ...
            &nbsp;<input class="form-result-new-form-button intec-button intec-button-reset intec-button-cl-common intec-button-s-6" type="reset" value="<?= GetMessage('FORM_RESET') ?>" />
        </div>
    <?php } ?>
