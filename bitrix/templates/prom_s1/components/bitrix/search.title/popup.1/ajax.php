...
/*
                   // $arPrices = $arItem['PRICES'];
                    ...
                    {
                        $arPrices =  CurrencyFormat($ar_res["PRICE"], $ar_res["CURRENCY"]);
                    }
                    else
                    {
                        $arPrices =  "Цена по запросу";
                    }
*/  
                    if(empty($arItem['CATALOG_PRICE_14'])){
                        $arPrices = '';
                    } else {
                        $arPrices = 'от ' . CurrencyFormat($arItem['CATALOG_PRICE_14'], $arItem['CATALOG_CURRENCY_14']);
                    }
