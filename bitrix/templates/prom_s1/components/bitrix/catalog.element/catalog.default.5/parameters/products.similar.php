...
else if ($arCurrentValues['PRODUCTS_SIMILAR_POSITION'] === 'content')
...
if (ArrayHelper::isIn($sTemplate, $arTemplates)) {
    ...
    $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
        ...
        function ($key, &$arParameter) use (&$arRecommendedCommonParameters) {
            ...
            $arParameter['NAME'] = Loc::getMessage('C_CATALOG_ELEMENT_DEFAULT_5_PRODUCTS_SIMILAR').' '.$arParameter['NAME'];
