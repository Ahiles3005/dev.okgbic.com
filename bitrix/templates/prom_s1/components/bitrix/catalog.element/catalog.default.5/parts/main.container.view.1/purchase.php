...
<div class="catalog-element-purchase-container" data-sticky="top" data-role="purchase">
            ...
            <div class="catalog-element-purchase-block">
                <div class="intec-grid intec-grid-wrap">
                    <div class="intec-grid-item-2">
                        <a href="/pay/" target="_blank" style="border: 1px solid #dddddd;
    border-radius: 5px;
    width: 75%;
    display: block;
    height: 35px;
    text-align: center;
    padding-top: 5px;
margin: auto;">Оплата</a>
                    </div>
                    <div class="intec-grid-item">
                        <a href="/delivery_and_pay/" target="_blank" style="border: 1px solid #dddddd;
    border-radius: 5px;
    width: 75%;
    display: block;
    height: 35px;
...
margin: auto;">Доставка</a>
    ...
    <div class="price-banner">
        <?= Html::img($arVisual['LAZYLOAD']['USE'] ? $arVisual['LAZYLOAD']['STUB'] : "/images/skidki_opt.jpg", [
            'alt' => "Оптовые скидки",
            'loading' => 'lazy',
            'data-lazyload-use' => $arVisual['LAZYLOAD']['USE'] ? 'true' : 'false',
            'data-original' => $arVisual['LAZYLOAD']['USE'] ? "/images/skidki_opt.jpg" : null
        ]) ?>
    </div>
</div>
<?if(isset($arResult['PROPERTIES']['RIGHT_TEXT']['VALUE']['TEXT']) && !empty($arResult['PROPERTIES']['RIGHT_TEXT']['VALUE']['TEXT'])):?>
    <div class="rightDescription">
        <?=$arResult['PROPERTIES']['RIGHT_TEXT']['VALUE']['TEXT']?>
    </div>
<?endif;?>