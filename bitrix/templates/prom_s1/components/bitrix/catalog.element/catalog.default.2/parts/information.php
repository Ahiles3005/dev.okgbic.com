...
<div class="intec-grid intec-grid-a-v-center">
    ...
    <?php } ?>
        <?php if ($arVisual['INFORMATION']['PAY']['SHOW']) { ?>
        <div class="catalog-element-other-information-item intec-grid-item">
            <div class="catalog-element-other-information-item-button intec-cl-text-hover intec-cl-border-hover" onclick="universe.components.show(<?= JavaScript::toObject([
                'component' => 'intec.universe:main.widget',
                'template' => 'catalog.information.1',
                'parameters' => [
                    'PATH' => $arVisual['INFORMATION']['PAY']['PATH']
                ],
                'settings' => [
                    'title' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_INFORMATION_PAYM'),
                    'parameters' => [
                        'width' => null
                    ]
                ]
            ]) ?>)">
                <?= Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_INFORMATION_PAY') ?>
            </div>
        </div>
    <?php } ?>
