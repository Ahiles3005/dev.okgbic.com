...
<?if($APPLICATION->GetCurPage() != "/catalog/"): ?> 
    ...
    <div class="catalog-section-list-items catalog-flexwrap intec-grid intec-grid-wrap intec-grid-a-v-sretch">
        <?php foreach ($arResult['SECTIONS'] as $numSection => $arSection) {
        ...
        ?>
            <?= Html::beginTag('div', [
                'class' => Html::cssClassFromArray([
                    ...
                    'intec-grid-item catalog-flexwrap_item' => [
                ...
                <?= Html::beginTag('div', [
                    'class' => Html::cssClassFromArray([
                        'catalog-section-list-item-wrapper catalog-flextop' => true,
                        'intec-grid' => [
                                '' => true,
...
//                                '400-wrap' => true
                    ...
                    <?php if ($arVisual['PICTURE']['SHOW']) { ?>
                        <div class="intec-grid-item-auto flex-wrapper_back intec-grid-item-400-1">
                            <?= Html::tag('a', null, [
                                'class' => [
                                ...
                                'data' => [
                                    ...
                                    'lazyload-use' => ($arVisual['LAZYLOAD']['USE'] && ($numSection || !empty($arResult['SECTION']['UF_DOPSV']))) ? 'true' : 'false',
                                    'original' => ($arVisual['LAZYLOAD']['USE'] && ($numSection || !empty($arResult['SECTION']['UF_DOPSV']))) ? $arPicture['SRC'] : null
                                ],
                                'style' => [
                                    'background-image' => ($arVisual['LAZYLOAD']['USE'] && ($numSection || !empty($arResult['SECTION']['UF_DOPSV']))) ? null : 'url(\''.$arPicture['SRC'].'\')'
                                ]
                            ]) ?>
<?= Html::tag('a', $arSection['NAME'], [
                    ...
                    <?php } ?>
                    <div class="intec-grid-item intec-grid-item-shrink-1 catalog-flex_bot intec-grid-item-400-1">
