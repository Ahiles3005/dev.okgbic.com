                            ...
                            <div class="menu-item-wrapper">
                                <?= Html::beginTag('div', [
                                    ...
                                    <div class="menu-information-items">
                                        <?php if ($arParams['SUBDOMAINS']) { ?>
                                            <div class="menu-information-item menu-information-city">
                                                <div class="intec-grid intec-grid-nowrap">
                                                    <div class="intec-grid-item-auto">
                                                        <i class="menu-information-icon glyph-icon-location_2"></i>
                                                    </div>
                                                    <div class="intec-grid-item">
                                                        <span data-toggle="modal" data-target="#cities" data-backdrop="1"><?= $arParams['SUBDOMAINS_CITY'] ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
                                                ...
                                                <?php } else { ?>
                                                    <div class="intec-grid intec-grid-nowrap">
                                                        <div class="intec-grid-item-auto">
                                                            ...
                                                            <?php } else { ?>
                                                                <i class="menu-information-icon intec-ui-icon intec-ui-icon-location-1"></i>
                                                            <?php } ?>
                                                        </div>
                                                        <div class="intec-grid-item">
                                                ...
                                                <div class="menu-information-item menu-information-phone-wrap">
                                                    <div data-role="phones" data-state="close">
                                                        <a href="tel:<?= $arPhones['SELECTED']['LINK'] ?>" class="menu-information-phone menu-information-text" data-role="phone.button">
                                                            <i class="menu-information-icon intec-ui-icon intec-ui-icon-phone-1"></i>
                                            ...
                                            <?php if ($arInformationView === 'view.2') { ?>
                                                <div class="menu-information-auth">
                                                    <a href="<?= $arAuthorization['VALUE'] ?>" class="menu-information-button-link menu-information-text">
                                                        <i class="menu-information-icon glyph-icon-user"></i>
