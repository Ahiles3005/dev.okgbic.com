                    ...
                    <div class="menu-wrapper-4 intec-grid intec-grid-nowrap intec-grid-a-h-start intec-grid-a-v-stretch" data-role="items">
                        ...
                        ?>
                           ...
                           <? } else {
                            ...
                            <?= Html::endTag('div') ?>
                        <?php } ?>
<?php if(0) { //блокируем вывод подменю more ... ?>
                        <?= Html::beginTag('div', [
                            'class' => Html::cssClassFromArray([
                                'menu-item' => [
                                    '' => true,
...
/*                     if($('.menu-item-text').hasClass('tot_click')){
                        $('.menu-item-text.tot_click').on('click', function (event) {
                        //var item = $(this).next();
                        var submenu;
                        //var level = item.attr('data-level');

                        submenu = $(this).parent().find('.menu-submenu.menu-submenu-1');
...
$(document).mouseup(function (e) {
    var container = $(".menu-item-text.tot_click").parent().find('.menu-submenu.menu-submenu-1');
    if (container.has(e.target).length === 0){
        container.hide().animate({'opacity': 0});
        overlay.stop().hide().animate({
                                    'opacity': 0
                                }, 300);
    }
});
