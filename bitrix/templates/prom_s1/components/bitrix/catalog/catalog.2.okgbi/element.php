...
$arSelect = Array("ID", "NAME", "PROPERTY_POLNOE_NAIMENOVANIE_ATTR_S");
$arFilter = Array("IBLOCK_ID"=>$arParams['IBLOCK_ID'], "ID"=>$arElement['ID'], "ACTIVE"=>"Y");
$res = CIBlockElement::GetList(Array(), $arFilter, false, Array(), $arSelect);
while($ob = $res->Fetch()){
    $h1 = $ob['PROPERTY_POLNOE_NAIMENOVANIE_ATTR_S_VALUE'];
}
pre($h1);
if($h1){
    global $APPLICATION;
