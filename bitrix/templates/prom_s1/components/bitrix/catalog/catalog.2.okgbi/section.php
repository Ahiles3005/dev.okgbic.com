...
$arFilter = Array('IBLOCK_ID'=>$arParams['IBLOCK_ID'], 'GLOBAL_ACTIVE'=>'Y', 'CODE'=>$GLOBALS['PAGE'][count($GLOBALS['PAGE'])-2]);
  $db_list = CIBlockSection::GetList(Array(), $arFilter, false,array('ID','NAME','CODE','UF_SHORTCONTENT'));
...
?>
<?if($curSection['UF_SHORTCONTENT']):?>
    <div class="sectionDescription intec-content">
        <div class="intec-content-wrapper">
            <?=$curSection['UF_SHORTCONTENT']?>
        </div>
    </div>
<?endif;?>
    <div class="catalog-wrapper intec-content intec-content-visible">
        <div class="catalog-wrapper-2 intec-content-wrapper">
            ...
            <?= Html::beginTag('div', [
                ...
                <?php } ?>
                <?if(!$_REQUEST['PAGEN_1'] && !$_REQUEST['PAGEN_2'] && !$_REQUEST['PAGEN_3']):?>
