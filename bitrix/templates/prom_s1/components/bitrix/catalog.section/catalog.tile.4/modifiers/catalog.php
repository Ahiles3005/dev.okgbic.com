...
//pre($arOffer['ITEM_PRICES']);
//pre($arOffer['MIN_PRICE']);
//pre($arOffer['PRICES']);
//pre('------');
            unset($arOffer);
...
//pre($arItem['MIN_PRICE']);
//pre($arItem['ITEM_PRICES']);
//pre($arItem['DOP_PRICE']);
//pre($arItem['SPECIAL_PRICE']);
//pre($arItem['MIN_OFFERS_PRICE']);
//pre($arItem['MIN_OFFERS_PRICE_PRINT']);
