        ...
        <?= Html::beginTag('div', [
            ...
            <?php } else { ?>
                ...
                <?= Html::beginTag($arResult['QUICK_VIEW']['DETAIL'] ? 'div' : 'a', [
                    ...
                    <div class="intec-aligner"></div>
                    <?= Html::img($sPicture, [
                        'srcset' => ($arVisual['LAZYLOAD']['USE'] && ($arItem['num'] || $arVisual['LAZY_FIRST'])) ? $arVisual['LAZYLOAD']['STUB'] : null,
                        'alt' => $arParentValues['NAME'],
                        'title' => $arParentValues['NAME'],
                        'loading' => ($arVisual['LAZYLOAD']['USE'] && ($arItem['num'] || $arVisual['LAZY_FIRST'])) ? 'lazy' : null,
                        'data-lazyload-use' => ($arVisual['LAZYLOAD']['USE'] && ($arItem['num'] || $arVisual['LAZY_FIRST'])) ? 'true' : null,
                        'data-original-set' => ($arVisual['LAZYLOAD']['USE'] && ($arItem['num'] || $arVisual['LAZY_FIRST'])) ? $sPicture : null
                    ]) ?>
                <?= Html::endTag($arResult['QUICK_VIEW']['DETAIL'] ? 'div' : 'a') ?>
            <?php } ?>
        <?= Html::endTag('div') ?>
