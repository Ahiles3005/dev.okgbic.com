        ...
        <?= Html::beginTag('div', [
            ...
            <div class="intec-grid-item-auto">
                <div class="catalog-section-item-price-discount intec-grid intec-grid-a-v-center">
                    <?php if (is_array($arItem['ITEM_PRICES']) && count($arItem['ITEM_PRICES']) > 1 && $arVisual['PRICE']['RANGE']) { ?>
                    <?php
                    ...
                    <?php if (/*!$arVisual['OFFERS']['USE']*/ $arPrice['PRICE']!=0 && !empty($arItem['OFFERS'])) { ?>
                        <?= Loc::getMessage('C_CATALOG_SECTION_CATALOG_TILE_4_PRICE_FORM') ?>
                    <?php } ?>
            ...
            <div class="intec-grid-item-auto">
					<span<?if(!empty($arPrice)):?> data-role="item.price.base"<?endif;?> class="catalog-section-item-price-base">
                        <?if($arPrice['PRICE']!=0):?>
