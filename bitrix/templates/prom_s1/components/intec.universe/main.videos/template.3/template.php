...
//pre($arItem);
                        ...
                        if(!empty($arItem['PROPERTIES']['LINK']['VALUE'])){
                            $url_l = $arItem['PROPERTIES']['LINK']['VALUE'];
                        }
                        if(!empty($arItem['PROPERTIES']['FILE']['VALUE'])){
                            $url = CFile::GetPath($arItem['PROPERTIES']['FILE']['VALUE']);
                        }
                        ...
                        <?= Html::beginTag('div', [
                            ...
                            <?/*?>
                                <?= Html::tag('div', $sSvg, [
                                   ...
                                   //'data-src' => 'https://okgbi.ru'.$url,
                                   'data-video' => '{"source": [{"src":"'.$url.'", "type":"video/mp4"}]}',
                                    'style' => [
                                ...
                                <?php } ?>
                               <?*/?>
                                   <video class="sm-video-object sm-html5" controls preload="true">
