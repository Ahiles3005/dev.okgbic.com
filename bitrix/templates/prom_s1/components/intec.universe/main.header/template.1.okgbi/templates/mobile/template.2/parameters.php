...
$arReturn['MOBILE_WHATSAPP_NUM'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_MOBILE_TEMP2_WHATSAPP_NUM'),
    'TYPE' => 'STRING',
];

$arReturn['MOBILE_WHATSAPP_TEXT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_MOBILE_TEMP2_WHATSAPP_TEXT'),
    'TYPE' => 'STRING',
];

$arReturn['MOBILE_TELEGRAM_NUM'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_MOBILE_TEMP2_TELEGRAM_NUM'),
    'TYPE' => 'STRING',
];
