...
<?= Html::beginTag('div', [
    ...
    <div class="widget-content">
        ...
        <div class="modal fade" id="cities" tabindex="-1" role="dialog" aria-labelledby="citiesModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <div class="modal-title" id="citiesModalLabel">Выбрать город</div>
              </div>
              <div class="modal-body"><?= subdomains_pages_links(); ?></div>
            </div>
          </div>
        </div>
        <?php } ?>
