...
$arResult['SUBDOMAINS'] = $arParams['SUBDOMAINS'] === 'Y';
...
if ($arResult['SUBDOMAINS'] && !empty($arResult['CONTACTS']['SELECTED'])) {
    if ($arResult['CONTACTS']['ADVANCED']) {
        $subdomain_phone = subdomains_phone($arResult['CONTACTS']['SELECTED']['PHONE']['DISPLAY']);
        if ($arResult['CONTACTS']['SELECTED']['PHONE']['DISPLAY'] !== $subdomain_phone) {
            $arResult['CONTACTS']['SELECTED']['PHONE']['VALUE'] = StringHelper::replace($subdomain_phone, [
                '(' => '',
                ')' => '',
                ' ' => '',
                '-' => ''
            ]);
            $arResult['CONTACTS']['SELECTED']['PHONE']['DISPLAY'] = $subdomain_phone;
        }
    } else {
        $subdomain_phone = subdomains_phone($arResult['CONTACTS']['SELECTED']['DISPLAY']);
        if ($arResult['CONTACTS']['SELECTED']['DISPLAY'] !== $subdomain_phone) {
            $arResult['CONTACTS']['SELECTED']['VALUE'] = StringHelper::replace($subdomain_phone, [
                '(' => '',
                ')' => '',
                ' ' => '',
                '-' => ''
            ]);
            $arResult['CONTACTS']['SELECTED']['DISPLAY'] = $subdomain_phone;
        }
    }
}
...
if ($arResult['SUBDOMAINS']) {
    $arResult['CITY'] = subdomains_city();
    $arResult['ADDRESS']['VALUE'] = subdomains_address($arResult['ADDRESS']['VALUE']);
    $arResult['EMAIL']['VALUE'] = subdomains_email($arResult['EMAIL']['VALUE']);
}
...
if(isset($GLOBALS['SUBDOMAINS']['SUBDOMAIN'])){
	$arParams['BANNER_SECTIONS'] = [$GLOBALS['SUBDOMAINS']['SUBDOMAIN']];
	$arParams['BANNER_BLOCKS_MODE'] = 'Y';
	$arParams['BANNER_BLOCKS_SECTIONS'] = [$GLOBALS['SUBDOMAINS']['SUBDOMAIN']];
}
