...
if ($arResult['SUBDOMAINS']) {
    $subdomain_phone = subdomains_phone($arResult['PHONE']['VALUE']['DISPLAY']);
    if ($arResult['PHONE']['VALUE']['DISPLAY'] !== $subdomain_phone) {
        $arResult['PHONE']['VALUE']['LINK'] = StringHelper::replace($subdomain_phone, [
            '(' => '',
            ')' => '',
            ' ' => '',
            '-' => ''
        ]);
        $arResult['PHONE']['VALUE']['DISPLAY'] = $subdomain_phone;
    }
