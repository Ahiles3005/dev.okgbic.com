                ...
                <div class="widget-block intec-grid-item-auto">
                    <?= Html::beginTag($sTag, [
                        ...
                        <?= Html::tag('div', '', [
                            ...
                            'data' => [
                                'lazyload-use' => $bBlockNum && $arVisual['LAZYLOAD']['USE'] ? 'true' : 'false',
                                'original' => $bBlockNum && $arVisual['LAZYLOAD']['USE'] ? $sBlockPicture : null
                            ],
                            'style' => [
                                'background-image' => !($bBlockNum && $arVisual['LAZYLOAD']['USE']) ? 'url(\''.$sBlockPicture.'\')' : null
                            ]
                        ]) ?>
                        <?php $bBlockNum += 1; ?>
