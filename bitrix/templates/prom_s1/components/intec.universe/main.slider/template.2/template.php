                        ...
                        ?>
                            <?= Html::beginTag($sTag, [
                                ...
                                'data' => [
                                    ...
                                    'lazyload-use' => $bSlideNum && $arVisual['LAZYLOAD']['USE'] ? 'true' : 'false',
                                    'original' => $bSlideNum && $arVisual['LAZYLOAD']['USE'] ? $sPicture : null
                                ],
                                'style' => [
                                    'background-image' => !($bSlideNum && $arVisual['LAZYLOAD']['USE']) ? 'url(\''.$sPicture.'\')' : null
                                ]
                            ]) ?>
                                <?php $bSlideNum += 1; ?>
