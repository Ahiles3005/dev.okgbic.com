                ...
                <?php $bActive = $arResult['COMPARE']['COUNT'] > 0 ?>
                    <div class="sale-basket-small-tab-wrap intec-grid-item-auto">
                        ...
                        <a rel="nofollow" href="<?= $arResult['URL']['COMPARE'] ?>" class="sale-basket-small-tab-wrapper">
                            <i class="sale-basket-small-tab-icon glyph-icon-compare" title="Сравнение"></i>
                            <?php if ($bActive) { ?>
                    ...
                    <div class="sale-basket-small-tab-wrap intec-grid-item-auto" data-role="tab" data-active="false" data-tab="delay">
                        <?= Html::beginTag($sTag, [
                            ...
                            <span class="sale-basket-small-tab-wrapper">
                                <i class="sale-basket-small-tab-icon glyph-icon-heart" title="Отложенные товары"></i>
                                <?php if ($bActive) { ?>
                ...
                ?>
                    <div class="sale-basket-small-tab-wrap intec-grid-item-auto" data-role="tab" data-active="false" data-tab="basket">
                        <?= Html::beginTag($sTag, [
                            ...
                            <span class="sale-basket-small-tab-wrapper">
                                <i class="sale-basket-small-tab-icon glyph-icon-cart" title="Корзина"></i>
                                <?php if ($bActive) { ?>
                                    <span class="sale-basket-small-tab-counter intec-cl-background-dark">
