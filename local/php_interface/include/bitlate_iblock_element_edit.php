...
if(!empty($PROP)):
	...
	$propertyEnumSize = array();
	$propertyEnumSizeDef = array();
    $iblockSites = array();
	$code = 'SIZE';
    $rsSites = CIBlock::GetSite($IBLOCK_ID);
    while($arSite = $rsSites->Fetch()) {
        $iblockSites[] = $arSite['LID'];
    }
    foreach ($iblockSites as $siteId) {
        $propertyEnumSizeDef[] = COption::GetOptionString("bitlate.proshop", "NL_ACTION_POS_VALUE", false, $siteId);
    }
    foreach($PROP as $prop_code=>$prop_fields):
		...
		?>
		<tr id="tr_PROPERTY_<?echo $prop_fields["ID"];?>"<?if ($prop_fields["PROPERTY_TYPE"]=="F"):?> class="adm-detail-file-row"<?endif?> data-property="<?=$prop_fields["CODE"]?>">
            ...
            <?if ($prop_fields["CODE"] == $code):
                $propertyEnum = CIBlockPropertyEnum::GetList(Array("DEF" => "DESC", "SORT" => "ASC"), Array("IBLOCK_ID" => $IBLOCK_ID, "CODE" => $code));
                while ($enumFields = $propertyEnum->GetNext()) {
                    /*if ($enumFields['DEF'] == 'Y') {
                        $propertyEnumSizeDef[] = $enumFields['XML_ID'];
                    }*/
                    $propertyEnumSize[$enumFields['XML_ID']] = $enumFields['ID'];
                }?>
                <script>
                    function hideUploadFields() {
                        $('tr[data-property="GORIZONTAL_MINI_PHOTO"]').hide();
                        $('tr[data-property="GORIZONTAL_RIGHT_PHOTO"]').hide();
                        $('tr[data-property="GORIZONTAL_PHOTO"]').hide();
                        $('tr[data-property="VERTICAL_PHOTO"]').hide();
                        $('tr[data-property="SQUARE_PHOTO"]').hide();
                        $('tr[data-property="SQUARE_MINI_PHOTO"]').hide();
                        $('tr[data-property="MIN_PRODUCT_PHOTO"]').hide();
                        $('tr[data-property="SQUARE_PRODUCT_PHOTO"]').hide();
                        $('tr[data-property="GORIZONTAL_PRODUCT_PHOTO"]').hide();
                        $('tr[data-property="SLIDER_PRODUCT_PHOTO"]').hide();
                    
                        $('tr[data-property="SIZE"] input[type="checkbox"]').each(function(){
                            if ($(this).is(':checked')) {
                                curVal = $(this).val();
                                switch (curVal) {
                                    case '<?=$propertyEnumSize['gorizontal_mini']?>':
                                        $('tr[data-property="GORIZONTAL_MINI_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['gorizontal_right']?>':
                                        $('tr[data-property="GORIZONTAL_RIGHT_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['gorizontal']?>':
                                        $('tr[data-property="GORIZONTAL_PHOTO"]').show();
                                        $('tr[data-property="SQUARE_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['vertical']?>':
                                        $('tr[data-property="VERTICAL_PHOTO"]').show();
                                        $('tr[data-property="SQUARE_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['gorizontal_4_2']?>':
                                        $('tr[data-property="GORIZONTAL_PHOTO"]').show();
                                        $('tr[data-property="SQUARE_MINI_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['vertical_4_2']?>':
                                        $('tr[data-property="VERTICAL_PHOTO"]').show();
                                        $('tr[data-property="SQUARE_MINI_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['square']?>':
                                        $('tr[data-property="SQUARE_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['square_mini']?>':
                                        $('tr[data-property="SQUARE_MINI_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['big_product']?>':
                                        $('tr[data-property="MIN_PRODUCT_PHOTO"]').show();
                                        $('tr[data-property="SQUARE_PRODUCT_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['gorizontal_priduct']?>':
                                        $('tr[data-property="MIN_PRODUCT_PHOTO"]').show();
                                        $('tr[data-property="GORIZONTAL_PRODUCT_PHOTO"]').show();
                                        break;
                                    case '<?=$propertyEnumSize['slider_recomend']?>':
                                    case '<?=$propertyEnumSize['slider_news']?>':
                                    case '<?=$propertyEnumSize['slider_hits']?>':
                                    case '<?=$propertyEnumSize['slider_discount']?>':
                                        $('tr[data-property="SLIDER_PRODUCT_PHOTO"]').show();
                                        break;
                                }
                            }
                        })
                    ...
                    $(document).ready(function() {
                        $('tr[data-property="SIZE"] input[value="<?=$propertyEnumSize['gorizontal_mini']?>"]').before("<div style=\"width: 240px; margin-left: 15px; height: 5px; margin-top: 5px;\"><strong><?=GetMessage("CUSTOM_MENU_ACTION_BANNER_BELOW")?></strong></div><br>");
                        $('tr[data-property="SIZE"] input[value="<?=$propertyEnumSize['gorizontal_right']?>"]').before("<div style=\"width: 240px; margin-left: 15px; height: 5px; margin-top: 5px;\"><strong><?=GetMessage("CUSTOM_MENU_ACTION_BANNER_RIGHT")?></strong></div><br>");
                        $('tr[data-property="SIZE"] input[value="<?=$propertyEnumSize['square']?>"]').before("<div style=\"width: 240px; margin-left: 15px; height: 5px; margin-top: 5px;\"><strong><?=GetMessage("CUSTOM_MENU_ACTION_BANNER_3_3")?></strong></div><br>");
                        $('tr[data-property="SIZE"] input[value="<?=$propertyEnumSize['square_mini']?>"]').before("<div style=\"width: 240px; margin-left: 15px; height: 5px; margin-top: 5px;\"><strong><?=GetMessage("CUSTOM_MENU_ACTION_BANNER_4_2")?></strong></div><br>");
                        $('tr[data-property="SIZE"] input[value="<?=$propertyEnumSize['big_product']?>"]').before('<div style=\"width: 240px; margin-left: 15px; height: 5px; margin-top: 5px;\"><strong><?=GetMessage("CUSTOM_MENU_ACTION_BANNER_PRODUCT")?></strong></div><br>');
                        $('tr[data-property="SIZE"] input[value="<?=$propertyEnumSize['slider_recomend']?>"]').before('<div style=\"width: 240px; margin-left: 15px; height: 5px; margin-top: 5px;\"><strong><?=GetMessage("CUSTOM_MENU_ACTION_BANNER_LINE")?></strong></div><br>');
                        hideUploadFields();
                        $(document).on("change", 'tr[data-property="SIZE"] input[type="checkbox"]', function() {
                            hideUploadFields();
                        });
                    })
                </script>
